...
class ChatTable:
    ...
    async def get_chat_scratchboard_by_id(self, id: str, user_id: str) -> str | None:
        """Read the scratchboard content from a chat owned by the user."""
    ...
    async def update_chat_scratchboard_by_id(self, id: str, user_id: str, content: str) -> ChatModel | None:
        """Update the scratchboard content on a chat owned by the user."""
        try:
            async with get_async_db_context() as db:
