	...
	<div class="canvas-scroll" use:scrollToBottom>
		<div class="messages-container">
			{#each messages as msg, i (msg.id)}
				<div class="msg-entry" class:user={msg.role === 'user'} class:agent={msg.role === 'assistant'}>
					<!-- Role Indicator -->
					<div class="msg-gutter">
						...
						>
							<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9 12 3l6 6"/><path d="M6 15l6 6 6-6"/></svg>
						</button>
					</div>
	...
	<div class="composer-dock" class:focused={composerFocused}>
		<div class="composer-inner">
			<div class="composer-toolbar">
				<button class="tool-btn" onclick={() => showBlockMenu = !showBlockMenu} aria-label="Add block">
			...
			<div class="composer-input-wrap">
				<textarea
					...
					onblur={() => { if (!inputValue) composerFocused = false; }}
					onkeydown={handleKey}
				></textarea>
...
<style>
	...
	.canvas-scroll::-webkit-scrollbar-thumb { background: var(--border); border-radius: 999px; }
	...
	.composer-dock.focused .composer-inner {
		...
		box-shadow: 0 0 0 3px var(--accent-glow), 0 8px 32px var(--shadow-color);
	}
